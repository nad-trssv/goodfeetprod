          ...
          <div class="row justify-content-between">
            <div class="col-lg-7 col-xl-6">
              <form id="storeBooking" class="needs-validation" novalidate="">
                ...
                <div class="row g-3 mb-5 mt-1">
                  <div class="col-sm-6">
                    <label class="fw-bold text-body-highlight mb-1 ff_secondary" for="client_name">{{ __('msg.name') }}</label>
                    <input class="form-control ff_secondary border_rounded" type="text" id="client_name" name="client_name" placeholder="{{ __('msg.name') }}" pattern=".{2,}" required>
                    <div class="invalid-feedback ff_secondary">{{ __('msg.required_input') }}</div>
                  </div>
                  <div class="col-sm-6">
                    <label class="fw-bold text-body-highlight mb-1 ff_secondary" for="client_lastname">{{ __('msg.surname') }}</label>
                    <input class="form-control ff_secondary border_rounded" type="text" id="client_lastname" name="client_lastname" placeholder="{{ __('msg.surname') }}" pattern=".{3,}" required>
                    <div class="invalid-feedback ff_secondary">{{ __('msg.required_input') }}</div>
                  </div>
                </div>
                <div class="row g-3">
                  <div class="col-sm-6">
                    <label class="fw-bold text-body-highlight mb-1 ff_secondary" for="client_email">Email</label>
                    <input class="form-control ff_secondary border_rounded" type="email" id="client_email" name="client_email" placeholder="example@mail.ru" required="">
                    <div class="invalid-feedback ff_secondary">{{ __('msg.required_input') }}</div>
                  </div>
                  <div class="col-sm-6">
                    <label class="fw-bold text-body-highlight mb-1 ff_secondary" for="client_phone">{{ __('msg.phone') }}</label>
                    <input class="form-control ff_secondary border_rounded" type="text" id="client_phone" name="client_phone" placeholder="+372 555 555 55" pattern="^\+[\d\s]+$" required>
                ...
                <div class="form-check mb-4">
                  ...
                  <label class="form-check-label fw-normal fs-8 text-body ff_secondary" for="policy">
                    ...
                    <span class="d-block fs-9 text-body-tertiary">
                      <p class="mb-2 mt-2 ff_secondary"><svg class="svg-inline--fa fa-circle text-body-quaternary fs-10 me-2" data-fa-transform="up-2" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="circle" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="" style="transform-origin: 0.5em 0.375em;"><g transform="translate(256 256)"><g transform="translate(0, -64)  scale(1, 1)  rotate(0 0 0)"><path fill="currentColor" d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512z" transform="translate(-256 -256)"></path></g></g></svg>
                ...
                <textarea class="form-control ff_secondary border_rounded" name="description" rows="5" id="description" placeholder="{{ __('msg.additional_info') }}" minlength="8"></textarea>
                <div class="invalid-feedback ff_secondary">{{ __('msg.required_input_min_8') }}</div>
                <input class="form-control ff_secondary mt-4 border_rounded" type="file" name="files[]" id="fileInput" multiple>
                <hr class="mt-7 mb-5">
                <button type="submit" class="btn_primary border_rounded text-center ff_secondary" href="">
                  {{ __('msg.book') }}
                </button>
              </form>
            </div>
            <div class="col-lg-5 col-xl-4">
              <div class="card mt-5 mt-lg-0">
                <div class="card-body">
                  <img class="rounded-2 mb-3" src="{{ asset('assets/img/logos/logo.svg') }}" alt="GoodFeet" width="100%" class="logoLarge logoContainer" />
                  <p class="mb-5 text-body-tertiary"><i class="fa-solid fa-location-dot me-2"></i> {{ $settings['company_address'] }}</p>
                  <div class="card mb-3">
                    <div class="card-body">
                      <div class="d-flex justify-content-between gap-3 mb-4">
                        <div>
                          ...
                          <p class="mb-0 text-body-tertiary">
                            {{ $bookingData['start'] }} - {{ $bookingData['end'] }} ({{ $service['effective_duration_minutes'] }} мин.)
                          </p>                          
                        </div>
                      </div>
