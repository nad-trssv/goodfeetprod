@section('title', __('admin_staff.profile'))
  <x-dashboard-layout>
    <div class="content">
      <nav class="mb-3" aria-label="breadcrumb">
        <ol class="breadcrumb mb-0">
          <li class="breadcrumb-item active">{{ __('admin_staff.profile') }}</li>
        </ol>
      </nav>
          ...
          <div class="col-12">
            <div class="border-bottom mb-4">
                <form id="profileForm" class="needs-validation" novalidate="">
                    ...
                    <div class="mb-6">
                        <h4 class="mb-4">{{ __('admin_staff.personal_information') }}</h4>
                        <div class="row g-3">
                            <div class="col-12 col-sm-6">
                                ...
                                <div class="form-floating">
                                    ...
                                    <label class="text-body-tertiary form-icon-label" for="name">{{ __('admin_staff.name') }}</label>
                                    <div class="invalid-feedback">{{ __('admin_staff.required_field') }}</div>
                            ...
                            <div class="col-12 col-sm-6">
                                ...
                                <div class="form-floating">
                                    ...
                                    <label class="text-body-tertiary form-icon-label" for="username">{{ __('admin_staff.nickname') }}</label>
                                    <div class="invalid-feedback">{{ __('admin_staff.required_field') }}</div>
                                </div><svg class="svg-inline--fa fa-user text-body fs-9 form-icon" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="user" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg=""><path fill="currentColor" d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512H418.3c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304H178.3z"></path></svg><!-- <span class="fa-solid fa-user text-body fs-9 form-icon"></span> Font Awesome fontawesome.com -->
                                </div>
                            </div>
                            <div class="col-12 col-sm-6">
                                ...
                                <div class="form-floating">
                                    ...
                                    <label class="text-body-tertiary form-icon-label" for="emailSocial">{{ __('admin_staff.enter_email') }}</label>
                                    <div class="invalid-feedback">{{ __('admin_staff.required_field') }}</div>
                            ...
                            <div class="col-12 col-sm-6">
                                ...
                                <div class="form-floating">
                                    ...
                                    <div class="invalid-feedback">{{ __('admin_staff.phone_hint') }}</div>
                                    <label class="text-body-tertiary form-icon-label" for="phone">{{ __('admin_staff.enter_phone') }}</label>
                            ...
                            <div class="col-12">
                              ...
                              <div class="form-text">{{ __('admin_staff.specialization_hint') }}</div>
                            </div>
                        </div>
                    </div>
                    <div class="row gx-3 mb-6 gy-6 gy-sm-3">
                            ...
                            <div class="row g-4 mb-4" data-dropzone="data-dropzone" data-options='{"maxFiles":1,"data":[{"name":"{{ $profile['profile_photo_storageFileName'] }}","size":"54kb","url":"{{ asset($profile['profile_photo_storage']) }}"}]}'>
                                ...
                                <div class="col-md">
                                    <div class="dz-message dropzone-area px-2 py-3" data-dz-message="data-dz-message">
                                        ...
                                        <h5 class="mb-2"><span class="fa-solid fa-upload me-2"></span>{{ __('admin_staff.upload_profile_photo') }}</h5>
                                        <p class="mb-0 fs-9 text-body-tertiary text-opacity-85 lh-sm">{{ __('admin_staff.upload_profile_photo_hint') }}</p>
                                        </div>
                                    </div>
                                </div>
                          </div>
                        ...
                        <div class="col-12 col-sm-6">
                            <h4 class="mb-4">{{ __('admin_staff.change_password') }}</h4>
                            <div class="form-icon-container mb-3">
                                <div class="form-floating">
                                <input class="form-control form-icon-input" id="oldPassword" type="password" name="oldPassword" placeholder="{{ __('admin_staff.old_password') }}">
                                <label class="text-body-tertiary form-icon-label" for="oldPassword">{{ __('admin_staff.old_password') }}</label>
                            ...
                            <div class="form-icon-container mb-3">
                                <div class="form-floating">
                                <input class="form-control form-icon-input" id="password" type="password" name="password" placeholder="{{ __('admin_staff.new_password') }}">
                                <label class="text-body-tertiary form-icon-label" for="password">{{ __('admin_staff.new_password') }}</label>
                            ...
                            <div class="form-icon-container">
                                <div class="form-floating">
                                <input class="form-control form-icon-input" id="password_confirm" type="password" name="password_confirm" placeholder="{{ __('admin_staff.repeat_new_password') }}">
                                <label class="text-body-tertiary form-icon-label" for="password_confirm">{{ __('admin_staff.repeat_new_password') }}</label>
                    ...
                    @if($services->count() > 0)
                        <div class="mb-6">
                            <h4 class="mb-3">{{ __('admin_staff.my_services') }}</h4>
                            <div class="row g-2">
                            ...
                            <p class="text-muted fs-10 mt-2">
                                ...
                                {!! __('admin_staff.manage_services',['link'=>'<a href="'.route('master.services.index').'">'.e(__('admin_staff.my_services')).'</a>']) !!}
                            </p>
                        </div>
                    @endif
                    <div class="text-end mb-6">
                        <div>
                        <button class="btn btn-phoenix-primary">{{ __('admin_staff.save') }}</button>
                        </div>
                    </div>
                </form>
            </div>
