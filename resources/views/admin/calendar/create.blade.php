...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const errorTargets={service_id:'serviceSelect',user_id:'masterSelect',client_name:'clientName',client_lastname:'clientLastname',client_phone:'clientPhone',client_email:'clientEmail',description:'clientDescription',admin_notes:'adminNotes',appointment_start:'bookingDate',appointment_end:'bookingDate',slot_hold_token:'bookingDate'};
