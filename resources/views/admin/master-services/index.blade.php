  ...
  <div class="content">
    ...
    <div class="row mb-4 align-items-center">
      <div class="col">
        ...
        <p class="text-muted mb-0">
          Подключайте услуги мастерам и задавайте
          индивидуальную цену, продолжительность
          и техническое время.
        </p>
      </div>
    ...
    <div class="card mb-4">
      <div class="card-body">
        <form
          method="GET"
          action="{{ route('admin.master-services.index') }}"
        ...
        >
          <div class="col-12 col-lg-8">
            ...
            >
              ...
              @foreach ($masters as $masterOption)
                <option
                ...
                >
                  ...
                  @if ($masterOption->username)
                    — {{ $masterOption->username }}
                  @endif
                </option>
              @endforeach
            </select>
          ...
          <div class="col-12 col-lg-4">
            ...
            >
              <span class="fas fa-arrow-right me-2"></span>
              Открыть услуги
            </button>
          </div>
        </form>
    ...
    @if (!$master)
      ...
      >
        ...
        <p class="text-muted mb-0">
          Выберите мастера в списке выше.
        </p>
      </div>
    @else
      ...
      <div class="service-filter-panel mb-3">
        ...
        >
          ...
          <div class="service-search">
            <span
              class="fas fa-search service-search__icon"
            ></span>
      ...
      <div class="service-list">
        ...
        @forelse ($allServices as $service)
          ...
          @php
            $masterService = $masterServices->get(
              $service->id
            );
          ...
          >
            ...
            <div
              ...
              class="collapse
                {{ $isFailedService ? 'show' : '' }}"
            >
              <form
                method="POST"
                action="{{ route(
                  'admin.master-services.update',
                  [
                    'masterId' => $master->id,
                    'serviceId' => $service->id,
                  ]
                  ...
                  <div class="setting-block">
                    ...
                    <div class="form-check form-switch mb-3">
                      <input
                        ...
                        name="use_default_price"
                        value="1"
                        id="admin_use_default_price_{{ $service->id }}"
                        {{ $useDefaultPrice
                          ? 'checked'
                          : '' }}
                      >
                      ...
                      <label
                        ...
                        for="admin_use_default_price_{{ $service->id }}"
                      >
                    ...
                    <label
                      class="form-label"
                      for="admin_price_override_{{ $service->id }}"
                    >
                      Индивидуальная цена
                    </label>
                    ...
                    <div class="input-group">
                      <input
                        ...
                        id="admin_price_override_{{ $service->id }}"
                        min="0"
                        max="99999999.99"
                        step="0.01"
                  ...
                  <div class="setting-block">
                    ...
                    <div class="form-check form-switch mb-3">
                      <input
                        ...
                        name="use_default_duration"
                        value="1"
                        id="admin_use_default_duration_{{ $service->id }}"
                        {{ $useDefaultDuration
                          ? 'checked'
                          : '' }}
                      >
                      ...
                      <label
                        class="form-check-label"
                        for="admin_use_default_duration_{{ $service->id }}"
                      >
                    ...
                    <label
                      class="form-label"
                      for="admin_duration_override_{{ $service->id }}"
                    >
                    ...
                    <div class="input-group">
                      <input
                        ...
                        id="admin_duration_override_{{ $service->id }}"
                        min="1"
                        max="1440"
                        step="1"
                  ...
                  <div class="setting-block">
                    ...
                    <div class="form-check form-switch mb-3">
                      <input
                        ...
                        name="use_default_min_duration"
                        value="1"
                        id="admin_use_default_min_duration_{{ $service->id }}"
                        {{ $useDefaultMinDuration
                          ? 'checked'
                          : '' }}
                      >
                      ...
                      <label
                        class="form-check-label"
                        for="admin_use_default_min_duration_{{ $service->id }}"
                      >
                    ...
                    <label
                      class="form-label"
                      for="admin_min_duration_override_{{ $service->id }}"
                    >
                    ...
                    <div class="input-group">
                      <input
                        ...
                        id="admin_min_duration_override_{{ $service->id }}"
                        min="1"
                        max="1440"
                        step="1"
                  ...
                  <div class="setting-block">
                    ...
                    <div class="row g-3">
                      <div class="col-12 col-sm-6">
                        <label
                          class="form-label"
                          for="admin_buffer_before_{{ $service->id }}"
                        >
                          До услуги
                        </label>
                        ...
                        <div class="input-group">
                          <input
                            ...
                            id="admin_buffer_before_{{ $service->id }}"
                            min="0"
                            max="1440"
                            step="1"
                      ...
                      <div class="col-12 col-sm-6">
                        <label
                          class="form-label"
                          for="admin_buffer_after_{{ $service->id }}"
                        >
                          После услуги
                        </label>
                        ...
                        <div class="input-group">
                          <input
                            ...
                            id="admin_buffer_after_{{ $service->id }}"
                            min="0"
                            max="1440"
                            step="1"
                    ...
                    <p class="setting-block__note">
                      ...
                      продолжительность услуги, но будет
                      учитываться при расчёте свободного времени.
                    </p>
                  </div>
                </div>
