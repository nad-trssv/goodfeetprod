...
<body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f4f4f4;">
    <table role="presentation"
        style="width: 100%; border-collapse: collapse; background-color: #ffffff; max-width: 600px; margin: auto;">
        <tr>
            <td style="padding: 20px; text-align: center;">
                <img src="{{ asset('assets/img/spot-illustrations/41.png') }}" alt="GoodFeet" width="250"
        ...
        <tr>
            <td style="padding: 20px;">
                <table role="presentation" style="width: 100%; border-collapse: collapse;">
                    ...
                    <tr>
                        <td colspan="2" style="text-align: right;"><strong>{{ __('msg.room_label') }}:</strong>
                            D1053</td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td style="padding: 20px;">
                <table role="presentation" style="width: 100%; border-collapse: collapse;">
                    <tr>
                        <td style="padding: 20px; text-align: left; font-weight: bold;">{{ __('msg.service_price') }}:
                        </td>
        ...
        <tr>
            <td colspan="2" style="padding: 20px; text-align: left; font-size: 14px; color: #6c757d;">
                ...
                <p><strong>{{ __('msg.phone_label') }}</strong> <a href="tel:{{ $company_phone }}"
                        style="color: #007bff; text-decoration: none;">{{ $company_phone }}</a></p>
                <p><strong>Email:</strong> <a href="mailto:{{ $company_email }}"
                        style="color: #007bff; text-decoration: none;">{{ $company_email }}</a></p>
            </td>
        </tr>
    </table>
</body>
