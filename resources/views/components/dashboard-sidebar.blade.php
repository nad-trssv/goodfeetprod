      ...
      <div class="navbar-vertical-content">
        <ul class="navbar-nav flex-column" id="navbarVerticalNav">
          ...
          <li class="nav-item">
              ...
              <div class="parent-wrapper label-1">
                <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="nv-project-management">
                  ...
                  <li class="nav-item"><a class="nav-link" href="{{ route('service.create') }}">
                      <div class="d-flex align-items-center"><span class="nav-link-text">Создать</span></div>
                    </a>
                  </li>
                </ul>
              </div>
            ...
            @can('is-superadmin')
            <div class="nav-item-wrapper">
              <a class="nav-link dropdown-indicator label-1" href="#nv-member-management" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-member-management">
                <div class="d-flex align-items-center">
                  <div class="dropdown-indicator-icon-wrapper">
                    <span class="fas fa-caret-right dropdown-indicator-icon"></span>
                  </div>
              ...
              <div class="nav-item-wrapper">
                <a class="nav-link {{ request()->routeIs('settings.index') ? 'active' : '' }} label-1" href="{{ route('settings.index') }}" role="button" data-bs-toggle="" aria-expanded="false">
                  <div class="d-flex align-items-center">
                    ...
                    <span class="nav-link-text-wrapper"><span class="nav-link-text">Настройки</span></span>
                  </div>
                </a>
              </div>
            @endcan
            ...
            <div class="nav-item-wrapper">
              <a class="nav-link {{ request()->routeIs('master.services.index') ? 'active' : '' }} label-1"
                ...
                <div class="d-flex align-items-center">
                  ...
                  <span class="nav-link-text-wrapper"><span class="nav-link-text">Мои услуги</span></span>
                </div>
              </a>
            </div>
          </li>
