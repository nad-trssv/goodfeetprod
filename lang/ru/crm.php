...
return [
    ...
    'widget_messages'=>'Тексты виджета по языкам',
    'widget_messages_hint'=>'Клиент увидит заголовок и приветствие на выбранном языке сайта. Пустой перевод автоматически заменяется текстом основного языка.',
    'default_language'=>'Основной язык',
    'language_disabled'=>'отключён',
