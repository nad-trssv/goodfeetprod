...
{
    protected $fillable = ['public_uuid','access_token_hash','customer_id','visitor_name','visitor_email','visitor_phone','status','assigned_to_user_id','last_message_at','closed_at'];
